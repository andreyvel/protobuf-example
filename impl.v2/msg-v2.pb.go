...
type Message struct {
	...
	NewField1   string                 `protobuf:"bytes,5,opt,name=newField1,proto3" json:"newField1,omitempty"`
	NewField2   string                 `protobuf:"bytes,6,opt,name=newField2,proto3" json:"newField2,omitempty"`
}
...
func (x *Message) GetNewField1() string {
	if x != nil {
		return x.NewField1
	}
	return ""
...
func (x *Message) GetNewField2() string {
	if x != nil {
		return x.NewField2
	}
	return ""
...
var file_msg_v2_proto_rawDesc = []byte{
	...
	0x70, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xbe, 0x01, 0x0a, 0x07, 0x4d, 0x65, 0x73, 0x73,
	...
	0x0b, 0x6c, 0x61, 0x73, 0x74, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x64, 0x12, 0x1c, 0x0a, 0x09,
	0x6e, 0x65, 0x77, 0x46, 0x69, 0x65, 0x6c, 0x64, 0x31, 0x18, 0x05, 0x20, 0x01, 0x28, 0x09, 0x52,
	0x09, 0x6e, 0x65, 0x77, 0x46, 0x69, 0x65, 0x6c, 0x64, 0x31, 0x12, 0x1c, 0x0a, 0x09, 0x6e, 0x65,
	0x77, 0x46, 0x69, 0x65, 0x6c, 0x64, 0x32, 0x18, 0x06, 0x20, 0x01, 0x28, 0x09, 0x52, 0x09, 0x6e,
	0x65, 0x77, 0x46, 0x69, 0x65, 0x6c, 0x64, 0x32, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x33,
}
...
var file_msg_v2_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_msg_v2_proto_goTypes = []interface{}{
	(*Message)(nil),               // 0: api.v2.Message
	(*timestamppb.Timestamp)(nil), // 1: google.protobuf.Timestamp
}
var file_msg_v2_proto_depIdxs = []int32{
	1, // 0: api.v2.Message.last_updated:type_name -> google.protobuf.Timestamp
